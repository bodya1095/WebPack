...
export const nodeModulePath = (nodeModuleName: string) => resolve(PROJECT_ROOT, `./node_module/${nodeModuleName}`);
// App_Name
export const APP_NAME = process.env.APP_NAME || 'WebPack Learning';
